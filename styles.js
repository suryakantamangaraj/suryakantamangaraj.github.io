...
exports.push([module.i, "@import url(https://fonts.googleapis.com/css?family=Cormorant+Garamond|Open+Sans:300i,300|Lato);"]);
// Module
exports.push([module.i, "*,\n*::after,\n*::before {\n  box-sizing: border-box;\n  margin: 0;\n  padding: 0;\n}\nhtml {\n  font-size: 10px;\n  font-family: \"Open Sans\", \"Segoe UI\", Tahoma, Geneva, Verdana, sans-serif;\n}\nbody {\n  width: 100vw;\n  overflow-x: hidden;\n  background-color: #17a598;\n}\nbody.isSideDrawerOpen {\n  overflow: hidden;\n}\n.back-icon {\n  width: 3.5rem;\n  display: inline-block;\n  position: fixed;\n  top: 0;\n  left: 0;\n  margin: 3.2rem 5rem;\n  cursor: pointer;\n  z-index: 11;\n}\n@media (max-width: 640px) {\n  .back-icon {\n    width: 3rem;\n    margin: 1rem 2rem;\n  }\n}\n@media (max-width: 460px) {\n  html {\n    font-size: 8px;\n  }\n}\n@media (max-width: 360px) {\n  html {\n    font-size: 7px;\n  }\n}\n@media (max-width: 270px) {\n  html {\n    font-size: 5px;\n  }\n}\n*::-webkit-scrollbar {\n  width: 0.5rem;\n  border-radius: 1rem;\n}\n*::-webkit-scrollbar-track {\n  -webkit-box-shadow: inset 0 0 6px rgba(0, 0, 0, 0.3);\n}\n*::-webkit-scrollbar-thumb {\n  background-color: rgba(255, 255, 255, 0.4);\n  outline: 1px solid slategrey;\n}", "",{"version":3,"sources":["styles.scss","app/_var.scss"],"names":[],"mappings":"AAEA;;;EAGE,sBAAA;EACA,SAAA;EACA,UAAA;AAAF;AAGA;EACE,eAAA;EACA,yEAAA;AAAF;AAGA;EACE,YAAA;EACA,kBAAA;EACA,yBClBS;ADkBX;AACE;EACE,gBAAA;AACJ;AAGA;EACE,aAAA;EACA,qBAAA;EACA,eAAA;EACA,MAAA;EACA,OAAA;EACA,mBAAA;EACA,eAAA;EACA,WAAA;AAAF;AACE;EATF;IAUI,WAAA;IACA,iBAAA;EAEF;AACF;AACA;EACE;IACE,cAAA;EAEF;AACF;AACA;EACE;IACE,cAAA;EACF;AACF;AAEA;EACE;IACE,cAAA;EAAF;AACF;AAGA;EACE,aAAA;EACA,mBAAA;AADF;AAIA;EACE,oDAAA;AADF;AAIA;EACE,0CAAA;EACA,4BAAA;AADF","file":"styles.scss","sourcesContent":["@import url('https://fonts.googleapis.com/css?family=Cormorant+Garamond|Open+Sans:300i,300|Lato');\n@import './app/var';\n*,\n*::after,\n*::before {\n  box-sizing: border-box;\n  margin: 0;\n  padding: 0;\n}\n\nhtml {\n  font-size: 10px;\n  font-family: 'Open Sans', 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;\n}\n\nbody {\n  width: 100vw; // height: 100vh;\n  overflow-x: hidden;\n  background-color: $bg-color;\n  &.isSideDrawerOpen {\n    overflow: hidden;\n  }\n}\n\n.back-icon {\n  width: 3.5rem;\n  display: inline-block;\n  position: fixed;\n  top: 0;\n  left: 0;\n  margin: 3.2rem 5rem;\n  cursor: pointer;\n  z-index: 11;\n  @media (max-width: 640px) {\n    width: 3rem;\n    margin: 1rem 2rem;\n  }\n}\n\n@media (max-width: 460px) {\n  html {\n    font-size: 8px;\n  }\n}\n\n@media (max-width: 360px) {\n  html {\n    font-size: 7px;\n  }\n}\n\n@media (max-width: 270px) {\n  html {\n    font-size: 5px;\n  }\n}\n\n*::-webkit-scrollbar {\n  width: 0.5rem;\n  border-radius: 1rem;\n}\n\n*::-webkit-scrollbar-track {\n  -webkit-box-shadow: inset 0 0 6px rgba(0, 0, 0, 0.3);\n}\n\n*::-webkit-scrollbar-thumb {\n  background-color: rgba(#fff, 0.4);\n  outline: 1px solid slategrey;\n}\n","$bg-color: #17a598;\n$color1: #e74c3c;\n$color2: #2c3e50;\n$color3: #db381b;\n$green: #17a598;\n$text-color: #ffffff;\n$black: #555;\n$off-white: #f8f8f8;\n$white: #fff;\n\n"]}]);
// Exports
